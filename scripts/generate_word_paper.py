...
# If the LaTeX file exists, we will produce a simple structured DOCX by extracting sections.
...
# Very small LaTeX-to-text extractor for the particular structure used earlier.
# This is not a full converter; it grabs title, abstract, sections, and bibliography.
...
# Bibliography - try to extract thebibliography env
